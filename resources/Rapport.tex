...
%Redo UML
\includegraphics[width=\textwidth]{img/uml.jpeg}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{Agencement des fichiers dans le workspace}\label{fig:rviz_rgb}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \centering
    %Better screens
    \includegraphics[width=1.5\textwidth, angle=270]{img/turtlebot.jpg}
    \caption{TurtleBot 4 en action}\label{fig:rviz_lidar}
  \end{subfigure}
